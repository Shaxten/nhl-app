...
const translations: Record<Language, Translations> = {
  en: {
    ...
    betting: {
      ...
      alreadyPredicted: 'You already have a prediction for this game. Use the Score Predictions page to edit it.',
  ...
  fr: {
    ...
    betting: {
      ...
      alreadyPredicted: 'Vous avez déjà une prédiction pour ce match. Utilisez la page Prédictions pour la modifier.',
